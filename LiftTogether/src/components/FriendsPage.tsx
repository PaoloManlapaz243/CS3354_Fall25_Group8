...
const suggestedUsers = [
  { id: 'u1', username: 'PowerLifter88', mutualFriends: 3, isOnline: true },
  { id: 'u2', username: 'CardioKing', mutualFriends: 2, isOnline: false },
  { id: 'u3', username: 'YogaMaster21', mutualFriends: 5, isOnline: true },
  { id: 'u4', username: 'CrossFitPro', mutualFriends: 1, isOnline: false },
  { id: 'u5', username: 'RunnerGirl99', mutualFriends: 4, isOnline: true },
];
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-sm">
                            {request.mutualFriends} mutual friends • {formatRequestTime(request.timestamp)}
                          </p>
                        </div>
                      </div>
                  ...
                  <div key={suggestedUser.id} className="flex items-center justify-between p-4 bg-[#1f1f1f] rounded-lg border border-[#404040] hover:border-[#4caeff]/50 transition-all">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">{suggestedUser.mutualFriends} mutual friends</p>
                      </div>
                    </div>
                    <button
